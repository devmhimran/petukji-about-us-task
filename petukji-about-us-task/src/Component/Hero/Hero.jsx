                    ...
                    <div className="hero__left flex items-center">
                        <div className="hero__content">
                            ...
                            <div className="download__button mt-3">
                                <a className='px-5 py-2.5 bg-[#3D8361] hover:bg-[#55af84] duration-300 text-white rounded-lg' href='https://play.google.com/store/apps/details?id=com.ratzz.petuk' target='_blank'>Download App</a>
                            </div>
