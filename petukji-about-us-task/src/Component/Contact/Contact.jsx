...
const Contact = () => {
    ...
    const handleContactForm = (e) => {
        ...
        axios.post('https://petuk-ji-server.vercel.app/contact-form', formAllData)
                    ...
                    <div className="card-body">
                        ...
                        <div className="grid grid-cols-2 gap-8">
                            ...
                            <div className="contact__form">
                                ...
                                <Alert className='my-4 text-xs' color="amber">You can only use <span className='bg-gray-300'>mahmud.bubt.150@gmail.com</span> to send contact info to get the bulk email. Because I used mailgun free subscription</Alert>
